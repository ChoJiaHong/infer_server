...
class GestureRecognitionService(gesture_pb2_grpc.GestureRecognitionServicer):
    ...
    def Recognition(self, request, context):
        ...
        try:
            ...
            timer.start()
            boxes, labels, probs = predictor.predict(img2, 10, 0.8)
            interval = timer.end()
            ...
            for i in range(boxes.size(0)):
                ...
                if label_name == "rhand_0":
                    text["Right"] = '0'
                elif label_name == "rhand_1":
                    text["Right"] = '1'
                elif label_name == "rhand_2":
                    text["Right"] = '2'
                elif label_name == "rhand_3":
                    text["Right"] = '3'
                elif label_name == "rhand_4":
                    text["Right"] = '4'
                elif label_name == "rhand_5":
                    text["Right"] = '5'
                elif label_name == "rhand_6":
                    text["Right"] = '6'
                elif label_name == "rhand_7":
                    text["Right"] = '7'
